...
#Make bot go
#============================================
cogList = ["utility.test", "community.hello", "community.goodbye", "community.love", "community.boost", "community.positivity", "utility.members", "campus.end", "campus.start", "community.banner", "community.reaction", "campus.rmp", "campus.class", "utility.embed", "community.starboard", "community.towoken", "campus.club", "campus.mbta", "campus.weather", "moderation.scamImage", "community.feedback", "community.pingrole", "community.troll", "moderation.warnings", "community.roleboost", "moderation.ticket", "community.lockin", "logging.joinLeave", "logging.memberLog", "logging.serverLog", "logging.messageLog", "logging.modLog", "community.leavePolitics", "community.joinPolitics", "moderation.modvote", "moderation.lockdown", "logging.caseLog", "moderation.modCommands", "moderation.purge", "moderation.timeout", "moderation.ban", "moderation.kick", "moderation.kickPolitics", "moderation.snitch", "community.reactionRole", "moderation.appealServer", "moderation.warnAppeal", "moderation.hardmute", "community.birthday", "community.classChat", "moderation.automodWarn", "moderation.unserious", "community.squadPing", "logging.modQueueReminder", "utility.help", "moderation.modTracker", "community.rule", "moderation.deleteUserData", "moderation.viewEdits", "moderation.modLockin", "community.pollee", "campus.emergency", "moderation.export", "community.bean"]
defaultCogs = ["utility.test", "community.hello", "community.goodbye", "community.love", "community.boost", "community.positivity", "utility.members", "community.banner", "community.reaction", "campus.rmp", "campus.class", "utility.embed", "community.starboard", "community.towoken", "campus.club", "campus.mbta", "campus.weather", "moderation.scamImage", "community.feedback", "community.pingrole", "community.troll", "moderation.warnings", "community.roleboost", "moderation.ticket", "community.lockin", "logging.joinLeave", "logging.memberLog", "logging.serverLog", "logging.messageLog", "logging.modLog", "community.leavePolitics", "community.joinPolitics", "moderation.modvote", "moderation.lockdown", "logging.caseLog", "moderation.modCommands", "moderation.purge", "moderation.timeout", "moderation.ban", "moderation.kick", "moderation.kickPolitics", "moderation.snitch", "community.reactionRole", "moderation.appealServer", "moderation.warnAppeal", "moderation.hardmute", "community.birthday", "community.classChat", "moderation.automodWarn", "moderation.unserious", "community.squadPing", "logging.modQueueReminder", "utility.help","moderation.modTracker", "community.rule", "moderation.deleteUserData", "moderation.viewEdits", "moderation.modLockin", "community.pollee", "campus.emergency", "moderation.export", "community.bean"]
